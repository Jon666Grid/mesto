...
const areaInput = formElement.querySelector('.form__text_type_area');
const imgInput = formElement.querySelector('.form__text_type_img');
const areaTitleCard = document.querySelector('.popup__title');
const imgUrlCard = document.querySelector('.popup__img');
